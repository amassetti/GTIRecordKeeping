...
import edu.gti.asd.ariel.recordkeeping.gui.teacher.*;
 ...
 * @author ariel
 */
public class GTIGenerateAdminReportsForm extends javax.swing.JFrame {
     ...
     */
    public GTIGenerateAdminReportsForm(ContextManager contextManager) {
        initComponents();
    ...
    private void jComboBoxCourseActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBoxCourseActionPerformed
        ...
        if (selectedCourse != null && !selectedCourse.getComboElementId().equals(-1)) {
            // TODO
            subjectsByCourseAndTeacher = subjectService.getSubjectsByCourseAndTeacher(selectedCourse.getComboElementId(), 1);

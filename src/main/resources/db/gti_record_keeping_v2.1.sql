...
CREATE TABLE IF NOT EXISTS `gti_record_keeping_v2`.`subject` (
  ...
  `subject_description` VARCHAR(100) NULL,
  `nfq_level` INT NULL,
...
-- -----------------------------------------------------
-- Table `gti_record_keeping_v2`.`teacher_subject`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `gti_record_keeping_v2`.`teacher_subject` ;

CREATE TABLE IF NOT EXISTS `gti_record_keeping_v2`.`teacher_subject` (
